              ...
              mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                if(ratting > 0) Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Padding(padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: Dimensions.paddingSizeSmall),
                    ...
                    Text(productModel.priceType == 'priceless' ? '' :  productModel.priceType == 'multiple_price' ? PriceConverter.convertPrice(context, double.tryParse(productModel.priceRangeList!.isNotEmpty ?  productModel.priceRangeList!.first.price! : '0')) :
                  ...
                  Text(productModel.priceType == 'priceless' ? '${getTranslated('priceless', context)}' : productModel.priceType == 'multiple_price' ?
                  'Starts From ${PriceConverter.convertPrice(context, double.tryParse(productModel.priceRangeList!.isNotEmpty ?  productModel.priceRangeList!.first.price! : '0'),
                ...
                Text('${getTranslated('min_order', context)} ${productModel.minimumOrderQuantity} pc',
