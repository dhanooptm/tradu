...
class AppConstants {
  ...
  //static const String baseUrl = 'http://192.168.50.47/Backend-6Valley-eCommerce-CMS';   /// Rashed
  static const String baseUrl = 'https://6am.one/6valley/client-dhanoop/test';
  ...
  static const String getOrderRequestList = '/api/v1/customer/order/order-request-list';

  /// Price Range Api
  static const String requestPriceUri = '/api/v1/products/product-price-inquiry';
  static const String contactSupplierUri = '/api/v1/products/product-inquiry';
  static const String orderRequestUri = '/api/v1/order/order-request';
