...
class Product {
  ...
  List<PriceRangeModel>? _priceRangeList;
  String? _priceType;
  ...
  List<PriceRangeModel>? get priceRangeList => _priceRangeList;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product_multi_price'] != null && json['product_multi_price'].isNotEmpty) {
      try {
        _priceRangeList = <PriceRangeModel>[];
        var decodedData = jsonDecode(json['product_multi_price']);
        decodedData.forEach((v) {
          _priceRangeList!.add(PriceRangeModel.fromJson(v));
        });
      } catch (e) {
        if (kDebugMode) {
          print('Error decoding product_multi_price: $e');
        }
        _priceRangeList = [];
      }
    } else {
...
class Variation {
  ...
  Variation({String? type, double? price, String? sku, int? qty, int? quantity}) {
    _type = type;
    _price = price;
    _sku = sku;
    _qty = qty;
