            ...
            return SingleChildScrollView(
              ...
              Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ReviewAndSpecificationSectionWidget(productModel: details.productDetailsModel,),


                  details.isReviewSelected?
                  Column(children: [

                  if(details.productDetailsModel?.priceType == 'single_price')...[ReviewSection(details: details),],
