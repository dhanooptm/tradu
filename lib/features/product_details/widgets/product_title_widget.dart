      ...
      child: Consumer<ProductDetailsController>(
        builder: (context, details, child) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            productModel?.priceType == 'multiple_price' ?
            PriceRangeTextWidget(productDetailsModel: productModel) : productModel?.priceType == 'priceless' ?
            const SizedBox() : CustomDirectionalityWidget(
            ...
            if(productModel!.discount != null && productModel!.discount! > 0)...[
              ...
              productModel?.priceType == 'priceless' || productModel?.priceType == 'multiple_price' ?
              const SizedBox() : CustomDirectionalityWidget(
            ...
            if(productModel?.priceType == 'single_price')...[
              Row(children: [
