...
class OrderRepository implements OrderRepositoryInterface{
  ...
  @override
  Future<ApiResponse> getOrderRequestList(int offset,int? limit) async{
    try{
      final response = await dioClient!.get('${AppConstants.getOrderRequestList}?limit=$limit&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e){
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
