                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FittedBox(child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        Text(product.discount! > 0 ? product.priceType == 'priceless' ? '' : product.priceType == 'multiple_price' ?
                        PriceConverter.convertPrice(context, double.tryParse(product.priceRangeList!.isNotEmpty ?  product.priceRangeList!.first.price! : '0'),) :
                        ...
                        Text(product.priceType == 'priceless' ? '${getTranslated('priceless', context)}' : product.priceType == 'multiple_price' ?

                        'Starts From ${PriceConverter.convertPrice(context, double.tryParse(product.priceRangeList!.isNotEmpty ?  product.priceRangeList!.first.price! : '0'),
                        ...
                        product.priceType == 'priceless' ? const SizedBox() : const SizedBox(width: Dimensions.paddingSizeSmall),

                        Text('${getTranslated('min_order', context)} ${product.minimumOrderQuantity} pc',
              ...
              product.discount! > 0 ? Positioned(top: 20, left: 10,
                child: Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                  ...
                  child: Directionality(textDirection: TextDirection.ltr,
                    child: Text(product.priceType == 'multiple_price' ?

                    'Starts From ${PriceConverter.percentageCalculation(context, double.tryParse(product.priceRangeList!.isNotEmpty ?  product.priceRangeList!.first.price! : '0'),
