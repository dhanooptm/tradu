...
class OrderDetailsStatusWidget extends StatelessWidget {
  ...
  const OrderDetailsStatusWidget({super.key, this.isRequest = false, this.orderRequest});
    ...
    Consumer<OrderDetailsController>(
      builder: (context, orderProvider, _) {
        return  Stack(children: [
          isRequest ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center, children: [
            RichText(text: TextSpan(
              ...
              TextSpan(text: orderRequest?.id.toString(),
            ...
            RichText(text: TextSpan(
              ...
              TextSpan(text: ' ${getTranslated('${orderRequest?.orderStatus}', context)}',
                  style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge,
                      color: orderRequest?.orderStatus == 'unread'?  ColorResources.getYellow(context) : ColorResources.getGreen(context)
                  )
              )
            ]),),
            const SizedBox(height: Dimensions.paddingSizeSmall,),

            Text(DateConverter.localDateToIsoStringAMPMOrder(DateTime.parse(orderRequest!.createdAt!)),
