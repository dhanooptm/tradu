...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ProductDetailsRepository(dioClient: sl(), sharedPreferences: sl()));
  ...
  ProductDetailsRepositoryInterface productDetailsRepositoryInterface = ProductDetailsRepository(dioClient: sl(), sharedPreferences: sl());
